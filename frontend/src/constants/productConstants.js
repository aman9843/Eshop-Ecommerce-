...
export const PRODUCT_TOP_PRODUCTS_REQUEST = 'PRODUCT_TOP_PRODUCTS_REQUEST'
export const PRODUCT_TOP_PRODUCTS_SUCCESS = 'PRODUCT_TOP_PRODUCTS_SUCCESS'
export const PRODUCT_TOP_PRODUCTS_FAIL = 'PRODUCT_TOP_PRODUCTS_FAIL'